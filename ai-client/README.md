...
Made with Astro and [Shadcn](https://ui.shadcn.com/) with [React](https://docs.astro.build/en/guides/integrations-guide/react/) Components. Shadcn is a UI Library similiar to Bootstrap. It's built on top of TailwindCSS. 
