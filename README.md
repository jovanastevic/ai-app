...
GET /user - alle User holen (kA, ob notwendig)

GET /user/:id - einzelnen User holen

POST /user - neuen User erstellen

PUT /user/:id - User updaten
...
## /chats
TODO anschauen aber maybe

GET /chats - alle Chats holen 

GET /chats/:id - einzelnen Chat holen
